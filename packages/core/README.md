...
The TypeScript SDK for [**kriya**](https://github.com/governex/kriya) (MCP for Desktop) — the governed runtime
...
`v0.0.1` — alpha. Part of the [kriya](https://github.com/governex/kriya) framework
