...
Scaffold a new local-first agent app — built on [**kriya**](https://github.com/governex/kriya) (MCP for Desktop),
the governed runtime that lets an AI agent safely drive a desktop app — in one command.

```bash
npm create kriya-app@latest my-app
# or
npx create-kriya-app my-app
```
