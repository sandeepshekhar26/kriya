...
An **kriya** desktop app, scaffolded by
[`create-kriya-app`](https://github.com/governex/kriya). Humans click
...
- [`@kriya/core`](https://github.com/governex/kriya/tree/main/packages/core) — the SDK
- [`@kriya/inspector`](https://github.com/governex/kriya/tree/main/packages/inspector) — the dev inspector you see on the right side of the app
- [`kriya`](https://github.com/governex/kriya/tree/main/crates/kriya) — the Rust agent host (audit, budget, memory, permissions, inference backends)
