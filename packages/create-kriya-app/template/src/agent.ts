 ...
 *
 * The Rust host decides *which* action to call and *why*; this module executes
 * that decision against the registry and reports the result + fresh state back.
 * It also collects host telemetry for the inspector panel.
 */
