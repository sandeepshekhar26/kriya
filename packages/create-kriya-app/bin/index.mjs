#!/usr/bin/env node
// Scaffolder for kriya desktop apps.
...
function usage() {
  console.log(`Usage: create-kriya-app <project-name>
...
function main() {
  ...
  if (!existsSync(TEMPLATE_DIR)) {
    die(`template not found at ${TEMPLATE_DIR}. Reinstall create-kriya-app.`);
  }
  ...
  console.log(`
✓ Created ${name}/ from kriya template.
