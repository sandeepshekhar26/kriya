...
[`create-agent-app`](https://github.com/governex/verb). Humans click
...
- [`@agent-native/core`](https://github.com/governex/verb/tree/main/packages/core) — the SDK
- [`@agent-native/inspector`](https://github.com/governex/verb/tree/main/packages/inspector) — the dev inspector you see on the right side of the app
- [`agent-native-host`](https://github.com/governex/verb/tree/main/crates/agent-native-host) — the Rust agent host (audit, budget, memory, permissions, inference backends)
