...
//! just Tauri. This is the cross-shell decoupling that lets verb bolt onto an existing app
...
//! both shells. The `@agent-native/sidecar` package is the Node/TS client for this protocol.
